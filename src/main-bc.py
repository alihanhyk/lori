...
params["W0"] = 0.001 * jax.random.normal(subkeys[0], shape=(64, 2))
params["b0"] = 0.001 * jax.random.normal(subkeys[1], shape=(64,))
params["W1"] = 0.001 * jax.random.normal(subkeys[2], shape=(64, 64))
params["b1"] = 0.001 * jax.random.normal(subkeys[3], shape=(64,))
params["W2"] = 0.001 * jax.random.normal(subkeys[4], shape=(2, 64))
params["b2"] = 0.001 * jax.random.normal(subkeys[5], shape=(2,))
...
with open(f"res/res-bc-k{args.key}.obj", "wb") as f:
    dill.dump(params, f)
